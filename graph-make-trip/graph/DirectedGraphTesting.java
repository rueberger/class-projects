...
public class DirectedGraphTesting {
    ...
    public void checkAdd() {
        DirectedGraph<Integer, Integer> u =
        ...
        assertEquals("Edge shouldn't exist in this direction",
                     false, u.contains(w, v, 5));
    ...
    public void checkSuccessorIterator() {
        ...
        DirectedGraph<Integer, Integer>.Edge vy = u.add(v, y, 5);
        DirectedGraph<Integer, Integer>.Edge xy = u.add(x, y, 5);
        Iteration<DirectedGraph<Integer, Integer>.Vertex> successors =
            u.successors(v);
        int vertCount = 0;
